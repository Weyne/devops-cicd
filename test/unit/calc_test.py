...
class TestCalculate(unittest.TestCase):
    ...
    def test_add_method_returns_correct_result(self):
        ...
        self.assertEqual(1, self.calc.add(1, 3))
    ...
    def test_power_method_returns_correct_result(self):
        self.assertEqual(49, self.calc.power(7, 2))
        self.assertEqual(343, self.calc.power(7, 3))
    ...
    def test_log10_method_returns_correct_result(self):
        self.assertEqual(5, self.calc.log(100000,10))
        self.assertEqual(2, self.calc.log(100,10))
    ...
    def test_log10_method_fails_with_nan_parameter(self):
        self.assertRaises(TypeError, self.calc.log, "2", 10)
        self.assertRaises(ValueError, self.calc.log, 2, 1)
        self.assertRaises(ValueError, self.calc.log, -2, 10)
